...
df_R10 = DataFrame(Dates=selected, Growth_cm=growth_setp, cumul_cm=cumul_growth_setp)
...
let
    df_R10.Growth_mm = cm_to_mm.(df_R10[!, :Growth_cm])
    df_R10.cumul_mm = cm_to_mm.(df_R10[!, :cumul_cm])
end

XLSX.writetable("arbre_R10.xlsx", df_R10)
