...
df_R11 = DataFrame(Dates=selected, Growth_cm=growth_setp, cumul_cm=cumul_growth_setp)
...
let
    df_R11.Growth_mm = cm_to_mm.(df_R11[!, :Growth_cm])
    df_R11.cumul_mm = cm_to_mm.(df_R11[!, :cumul_cm])
end

XLSX.writetable("arbre_R11.xlsx", df_R11)
