...
df_arbre_A5_R2BV = DataFrame(Dates=selected, Growth_mm=growth_setp, cumul_mm=cumul_growth_setp)
XLSX.writetable("arbre_R5_R2B_V.xlsx", df_arbre_A5_R2BV)