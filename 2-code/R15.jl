...
df_R15 = DataFrame(Dates=selected, Growth_cm=growth_setp, cumul_cm=cumul_growth_setp)
...
let
    df_R15.Growth_mm = cm_to_mm.(df_R15[!, :Growth_cm])
    df_R15.cumul_mm = cm_to_mm.(df_R15[!, :cumul_cm])
end

XLSX.writetable("arbre_R15.xlsx", df_R15)
